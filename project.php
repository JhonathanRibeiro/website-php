...
<!-- Mirrored from inovatik.com/evolo/project.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 May 2021 23:53:02 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Evolo is a business Bootstrap HTML template which has a light illustrative design style and was built to help you create beautiful and efficient websites for companies and startups">
    ...
    <!-- Webpage Title -->
    <title>Project Details - Evolo</title>
...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <h1>Long project details title</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="ex-basic-1 pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-fluid mt-5 mb-4" src="images/article-details-large.jpg" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
...
<!-- Mirrored from inovatik.com/evolo/project.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 May 2021 23:53:03 GMT -->
</html>