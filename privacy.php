...
<!-- Mirrored from inovatik.com/evolo/privacy.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 May 2021 23:53:03 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Evolo is a business Bootstrap php template which has a light illustrative design style and was built to help you create beautiful and efficient websites for companies and startups">
    ...
    <!-- Webpage Title -->
    <title>Privacy Policy - Evolo</title>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="index.php#services">Services <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <ul class="list-unstyled li-space-lg mb-5">
                        ...
                        <li class="media">
                            <strong>4.</strong>
                            <div class="media-body"><strong>Leon is an easy</strong> to customize landing page php template built with Bootstrap for promoting mobile apps to the online audience and making visitors download them from app stores built by the media companies</div>
                        </li>
                        <li class="media">
                            <strong>5.</strong>
                            <div class="media-body"><strong>This template</strong> is built with php, CSS and Bootstrap to ensure the highest flexibility for all users. All designers, developers and tech-savvy people will be able to customize and modify all required aspects</div>
                        </li>
                    </ul>
                    ...
                    <a class="btn-solid-reg mb-5" href="index.php#registration">Register</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-col first">
                        <h6>About Evolo</h6>
                        <p class="p-small">Evolo is a business website Bootstrap php template which has a light illustrative design and was built to help you create beautiful websites</p>
